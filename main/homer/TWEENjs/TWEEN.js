...
var Tween = {
    ...
    Elastic: {
        ...
        easeInOut: function(b, c, d, t, a, p) {
            var s;
            if (t==0) return b;
    ...
    Back: {
        easeIn: function(b, c, d, t, s) {
            if (typeof s == "undefined") s = 1.70158;
            return c * (t /= d) * t * ((s + 1) * t - s) + b;
        },
        easeOut: function(b, c, d, t, s) {
            if (typeof s == "undefined") s = 1.70158;
            return c * ((t = t/d - 1) * t * ((s + 1) * t + s) + 1) + b;
        },
        easeInOut: function(b, c, d, t, s) {
            if (typeof s == "undefined") s = 1.70158;
